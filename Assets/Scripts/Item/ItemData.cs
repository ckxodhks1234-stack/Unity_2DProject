...
public class ItemData : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //=====================장비===========================
        var drill1 = new ItemInfo("드릴1", ItemType.Equipment, 2000, 3000, drill1Sprite, EquipType.Drill);
        allItems.Add(drill1);
        var drill2 = new ItemInfo("드릴2", ItemType.Equipment, 5000, 7000, drill2Sprite, EquipType.Drill);
        allItems.Add(drill2);

        var helmet1 = new ItemInfo("헬멧1", ItemType.Equipment, 2000, 3000, helmet1Sprite, EquipType.Helmet);
        allItems.Add(helmet1);
        var helmet2 = new ItemInfo("헬멧2", ItemType.Equipment, 5000, 7000, helmet1Sprite, EquipType.Helmet);
        allItems.Add(helmet2);

        var shoes1 = new ItemInfo("신발1", ItemType.Equipment, 2000, 3000, shoes1Sprite, EquipType.Shoes);
        allItems.Add(shoes1);                                      
        var shoes2 = new ItemInfo("신발2", ItemType.Equipment, 5000, 7000, shoes2Sprite, EquipType.Shoes);
        allItems.Add(shoes2);
    }
